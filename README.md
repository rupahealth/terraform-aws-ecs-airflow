...
| airflow\_image\_tag | The tag of the airflow image | `string` | `"2.0.1-python3.8"` | no |
...
| ecs\_cpu | The allocated cpu for your airflow instance | `number` | `2048` | no |
| ecs\_memory | The allocated memory for your airflow instance | `number` | `4096` | no |
